...
#define BOARD_NAME                    "LifoFifo Switch"        // Name of your product. Should match App Export request info.
#define BOARD_VENDOR                  "LifoFifo Switch"        // Name of your company. Should match App Export request info.
#define BOARD_TEMPLATE_ID             "TMPL05000"            // ID of the Tile Template. Can be found in Tile Template Settings

#define PRODUCT_WIFI_SSID             "LifoFifo Switch"         // Name of the device, to be displayed during configuration. Should match export request info.
